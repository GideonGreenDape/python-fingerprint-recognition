...
def normalise(img, mean, std):
    # Normalize the image using the mean and std deviation
...
def ridge_segment(im, blksze, thresh):
    ...
    # Normalize to get zero mean and unit standard deviation
    im = normalise(im, 0, 1)
    ...
    # Create padded images for processing
    ...
    # Calculate standard deviation in blocks
    ...
    # Calculate mean and std deviation of the normalized image
